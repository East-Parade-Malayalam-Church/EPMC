...
public class SeniorChristianFellowship extends AppCompatActivity {
    ImageView iv19;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_senior_christian_fellowship);
        iv19 = findViewById(R.id.imageView19);
        registerForContextMenu(iv19);
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.context_sharepic:
                ...
                i.setType("image/*");
                Uri uri = Uri.parse("android.resource.//com..example.epmc/drawable"+R.drawable.seniorchristian2400250);

...
public class LifeatEastparade extends AppCompatActivity {
    ImageView iv39;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lifeat_eastparade);
        iv39 = findViewById(R.id.imageView39);
        registerForContextMenu(iv39);
    }
    @Override
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.context_sharepic:
                ...
                i.setType("image/*");
                Uri uri = Uri.parse("android.resource.//com..example.epmc/drawable"+R.drawable.womensfellowship6);
